---
title: "NocoBase v2.1.0-alpha.40: adicionar comandos de criação e restauração de backup"
description: "Nota de lançamento da v2.1.0-alpha.40"
---
...
- **[flow-engine]** Os menus de configuração de campo V2 agora suportam pesquisa de campos ([#9489](https://github.com/nocobase/nocobase/pull/9489)) por @zhangzhonghe
...
- **[undefined]**
  ...
  - Adicionar revisão de segurança de dependências para pull requests por @zhangzhonghe

  - Adicionar revisão de segurança de dependências para pull requests por @zhangzhonghe

- **[Verificação]** Adicionar cliente v2 ao plugin de Verificação (página de configurações de administrador, entrada do centro do usuário, formulários SMS OTP). ([#9515](https://github.com/nocobase/nocobase/pull/9515)) por @Molunerfinn
...
- **[Workflow: Aprovação]** Adicionar sinalizador `async` para instrução de aprovação, para adaptar a nova API de criação de nó no canvas do workflow por @mytharcher

### 🐛 Correções de Bugs

- **[client]**
  - Corrigido o carregamento em modo dev para plugins de armazenamento integrados que dependem de exportações nomeadas de plugins de origem locais. ([#9548](https://github.com/nocobase/nocobase/pull/9548)) por @Molunerfinn
...
- **[client-v2]** Corrigido registro inconsistente de dependência dnd-kit. ([#9544](https://github.com/nocobase/nocobase/pull/9544)) por @jiannx
...
- **[Ação: Atualização em lote]** corrigir estado de carregamento da ação de atualização em massa após falha na atualização ([#9509](https://github.com/nocobase/nocobase/pull/9509)) por @katherinehhh

- **[Workflow]** Adicionar estado de carregamento para execução manual do workflow. ([#9533](https://github.com/nocobase/nocobase/pull/9533)) por @mytharcher

- **[Gerenciador de migração]** Corrigido falhas na criação de arquivos de migração ao usar OceanBase por @2013xile

- **[Armazenamento de arquivos: S3(Pro)]** Corrigir manipulação de endpoint S3 Pro para que uploads de servidor e pré-visualizações de URL não dupliquem o host do bucket. por @mytharcher
