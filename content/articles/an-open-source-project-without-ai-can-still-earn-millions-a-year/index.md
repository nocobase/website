...
Then I came across **Lijia’s** profile.
An energetic, outdoors-loving girl with a bright smile and white teeth - and I knew right away she was the right one.
...
As for me - I’m a husband and father of two elementary-school-aged children. My wife and I have been together since university. She has a passion for life, and almost every morning and evening, our family sits down together for home-cooked meals. Our kids get to enjoy their mother’s cooking every day. We also have a cat, a bird, and a large tank full of fish and shrimp.
...
Whether at the dinner table or on the road, we have long conversations - about school, books, their thoughts, and sometimes about our products, team, and customers. They love reading, play sports, eat everything, and solve problems calmly.
...
Several members of the NocoBase team are also fathers. Some go camping and fishing every week; others always travel with their laptops because developing NocoBase is their favorite hobby.
...
**Problem 1:**
We used the Email Manager plugin to sync Gmail into our CRM, so every customer record displayed the full email history. But when conversations span months and dozens of messages, reviewing them to understand a customer’s tone or intent took too much time.

**Problem 2:**
We often receive inquiries from unfamiliar companies in different countries. Before replying, we want to know who they are - what they do, their size, and which edition might fit them.
...
Next to each lead, another AI Employee, **Vera**, gathers background information. She reads the lead’s data - email domain, content, and signature - searches the web for relevant company and contact info, compiles a background report, and fills it into the CRM automatically. Again, no manual input or switching needed.

![img2](https://static-docs.nocobase.com/2025-10-31_21-24-31.png)

**Orin** builds data models. **Vix** analyzes data insights. **Lexi** translates across languages. **Nathan** writes frontend code.
...
So, will AI kill NocoBase?

If AI ever becomes powerful enough to kill NocoBase, it won’t stop there - it would change life itself, in ways far more serious than one project disappearing.
If it doesn’t, then the stronger AI becomes, the more NocoBase will benefit.
...
For a small team like ours, being alive in this era of AI is a great stroke of luck - just as the iPhone once ushered in the smartphone age, unlocking unprecedented opportunities for developers worldwide.
Today, while major players and startups with vast resources create dazzling AI products, they also leave behind plenty of open space - room for small, focused teams like ours to thrive.
