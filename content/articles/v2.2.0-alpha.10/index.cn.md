...
- **[AI 员工]** 修复 AI 员工模型设置保存、禁用员工创建会话以及移动端聊天框布局行为的问题。 ([#10120](https://github.com/nocobase/nocobase/pull/10120)) by @cgyrock
...
- **[undefined]** 修正文档中的 PLUGIN_PACKAGE_PREFIX 示例，确保预设插件使用 @nocobase/preset- 前缀。 ([#10179](https://github.com/nocobase/nocobase/pull/10179)) by @hongboji
...
- **[工作流：审批]**
  ...
  - 修复未启用退回操作时审批人仍可退回申请的问题 by @zhangzhonghe
