...
毎年、ロシア・サンクトペテルブルクで開催される「Flat White Champ」ダンスフェスティバルには、数百人ものダンサーが集まります。新人には輝くチャンスを、プロには最高のステージを——ライブ公演から高品質な配信、観光や文化との連携まで、このフェスティバルは街の文化を象徴する存在となっています。
...
NocoBase を導入し、プログラム全体を統合的に管理できるデジタルシステムを構築しました。
