...
- **[数据可视化]** 新增图表SQL数据源 ([#7830](https://github.com/nocobase/nocobase/pull/7830)) by @heziqiang
...
- **[AI 员工]** 在 v1 页面隐藏AI员工对话按钮 ([#7829](https://github.com/nocobase/nocobase/pull/7829)) by @cgyrock
