...
**概要**：NocoBase は、業務用バックエンドシステムの構築を目的とした、オープンソースの AI 駆動型ローコード／ノーコードプラットフォームです。柔軟なデータモデリングに加え、強力な RBAC 権限管理機能を備えており、AI 駆動の支援を活用しながら、CRM、ERP、CMS などの多役割・多ユーザーを想定した企業向けアプリケーションに適しています。
