...
## **No.1 NocoBase：オープンソースの AI ノーコードプラットフォーム**
...
**概要**：NocoBase は、業務用バックエンドシステムの構築を目的とした、オープンソースの AI ローコード／ノーコードプラットフォームです。柔軟なデータモデリングと強力な RBAC 権限管理機能を備えており、CRM、ERP、CMS などの多役割・多ユーザーを想定した企業向けアプリケーションに適しています。
