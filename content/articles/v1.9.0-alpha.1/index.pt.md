---
title: "NocoBase v1.9.0-alpha.1: Adicionar fila de eventos para processar mensagens na fila"
description: "Nota de lançamento da v1.9.0-alpha.1"
---
...
- **[Calendário]** definir dia de início da semana como 'segunda-feira' no bloco de calendário ([#7171](https://github.com/nocobase/nocobase/pull/7171)) por @katherinehhh
...
- **[Workflow]** Corrigir o problema onde múltiplos deslizes para a esquerda são necessários para retornar à página anterior em dispositivos móveis ([#7165](https://github.com/nocobase/nocobase/pull/7165)) por @zhangzhonghe
