...
* **Dolibarr**：モジュール型の CRM プラットフォームで、モジュールや API を使って外部 AI システムと連携できる。
...
AI 機能ドキュメント：[https://v2.docs.nocobase.com/ai-employees](https://v2.docs.nocobase.com/ai-employees)
