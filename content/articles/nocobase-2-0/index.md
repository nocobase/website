...
- [访问新文档 (持续开发中)](https://v2.docs.nocobase.com/cn/)
...
- [了解 FlowEngine](https://v2.docs.nocobase.com/cn/flow-engine)
...
- [了解 AI 员工](https://v2.docs.nocobase.com/cn/ai-employees)
...
更多详情请查看 [插件升级指南](https://v2.docs.nocobase.com/plugin-development/plugin-upgrade-guide)
