...
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| 💡**智能代理与自动化工作流工具**<br/>           | No.1 AutoGPTNo.3 n8nNo.4 LangChainNo.18 gpt-engineer                                                                                              | 用于构建多步任务执行、流程编排与自主代理系统的开发框架和工具。                  |
| **🎨 多模态生成 / 提示词工具 / 数据与运维平台** | No.2 Stable Diffusion web UINo.8 SupabaseNo.9 ComfyUINo.10 NetdataNo.11 system-prompts-and-models-of-ai-toolsNo.12 Deep-Live-CamNo.20 Meilisearch | 覆盖图像生成、提示工程、实时监控与后端数据平台，拓展 AI 工具的应用边界与效率。  |
| **💬 可视化聊天界面与 AI 应用前端**<br/>        | No.5 DifyNo.6 Open WebUINo.14 Lobe ChatNo.19 ChatGPT                                                                                              | 提供开源聊天界面或前端工具，支持接入大语言模型并快速搭建对话类应用。            |
| 📚**知识问答 / 文档 RAG 系统**<br/>             | No.13 GlamaNo.16 RAGFlow                                                                                                                          | 支持基于文档的知识检索与问答功能，适合搭建企业知识库与智能客服系统。            |
| 🧠**模型训练 / 微调 / 教学资源**                | No.7: Generative AI for BeginnersNo.15 LLMs-from-scratchNo.17 LLaMA Factory                                                                       | 包含 LLM 的训练、微调工具及从零构建大模型的学习资料，适合模型开发者入门或进阶。 |
