...
**NocoBase** は、データ駆動型アプリケーションを容易に構築できる AI ノーコード（ゼロコード）／ローコードプラットフォームです。NocoBaseのロゴが削除された有料版も用意されています。オープンソースであるため、GitHubで簡単に貢献できます。また、必要に応じてプラットフォームの機能を拡張するためのプラグインシステムも提供しています。
