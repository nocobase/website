...
## Here’s a quick look at 7 self-hosted AI tools worth your attention:

1. **NocoBase**: A no-code and low-code development platform where AI assistants help drive processes and deliver intelligent analytics.
2. **Flowise AI**: A visual workflow builder for AI, built in the LangChain library.
3. **AnythingLLM**: A private knowledge base and enterprise Q&A system that supports RAG (retrieval-augmented generation).
4. **SuperAGI**: A multi-agent collaboration framework in which AI agents autonomously carry out tasks.
5. **n8n**: An automation workflow platform with built-in AI triggers for self-hosted integration.
6. **LibreChat**: A ChatGPT-style internal chat interface designed for enterprise use and linking local models.
7. **DocsGPT**: A document and knowledge automation assistant that generates API documentation and FAQs.
...
**Website:**[https://www.librechat.ai](https://www.librechat.ai)
...
**Website:**[https://www.docsgpt.cloud](https://www.docsgpt.cloud)
