...
- **[undefined]** Add top-level proxy commands for nginx and caddy ([#9721](https://github.com/nocobase/nocobase/pull/9721)) by @chenos

- **[Backup manager]** Adapt to the new version control plugin ([#9563](https://github.com/nocobase/nocobase/pull/9563)) by @cgyrock
...
- **[Data source manager]** Improved V2 data source manager error messages when collection, field, sync, and table-loading operations fail. ([#9710](https://github.com/nocobase/nocobase/pull/9710)) by @katherinehhh

- **[AI employees]** Fixed the missing Dara assistant button in client-v2 chart settings. ([#9696](https://github.com/nocobase/nocobase/pull/9696)) by @cgyrock
