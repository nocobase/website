...
NocoBase 是一个开源、AI 驱动的无代码／低代码业务应用构建平台，用于搭建内部系统、管理后台以及以数据为中心的业务流程。平台支持自托管，也提供官方托管方案，适合希望从表格迁移到系统化管理的团队。系统基于可视化配置构建应用，并可通过插件和 API 扩展能力，在部分场景下还可以结合官方提供的 AI 功能，进一步提升数据录入与流程处理效率。
