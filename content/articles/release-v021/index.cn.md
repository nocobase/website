...
[更多内容查看 [工作流 - 操作后事件] 文档](https://docs-cn.nocobase.com/handbook/workflow-custom-action-trigger)

#### 操作前事件

![20240407222834](https://nocobase-docs.oss-cn-beijing.aliyuncs.com/20240407222834.png)

[更多内容查看 [工作流 - 操作前事件] 文档](https://docs-cn.nocobase.com/handbook/workflow-request-interceptor)
...
本地访问 URL [http://localhost:13000/nocobase/](http://localhost:13000/nocobase/)
