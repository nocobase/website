...
💡続きを読む：[Excel を置き換えるシステムをすばやく構築するには？（完全ガイド）](https://www.nocobase.com/cn/blog/how-to-quickly-build-a-real-system-to-replace-excel)
...
💡注目事例：[紙からデジタルへ：この医療製造企業が NocoBase を選んだ理由 - NocoBase](https://www.nocobase.com/cn/blog/medical-device-manufacturer-builds-self-hosted-management-system-with-nocobase)
...
🎉  [NocoBase 2.0 チュートリアル](https://docs.nocobase.com/cn/tutorials/v2/)が公開されました。工单システムを例に、0 から 1 まで一式の業務システムを構築する流れを学べます。ぜひご覧ください。
...
💡続きを読む：[NocoBase vs Airtable: 柔軟でカスタマイズしやすいオープンソースの代替案](https://www.nocobase.com/en/blog/nocobase-vs-airtable)
...
💡続きを読む：[ロール権限管理（RBAC）に対応した 6 つの開発ツール比較と活用シーン解説 - NocoBase](https://www.nocobase.com/cn/blog/6-developer-tools-with-rbac-support)
...
💡続きを読む：[Google Sheets のおすすめ代替ツール 8 選（コストと機能分析付き）](https://www.nocobase.com/cn/blog/the-8-best-google-sheets-alternatives-with-full-cost-and-capability-analysis)
