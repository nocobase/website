...
### [v2.0.15](https://www.nocobase.com/cn/blog/v2.0.15)
...
### [v2.0.14](https://www.nocobase.com/cn/blog/v2.0.14)
...
- **[迁移管理]**
  ...
  - 修复迁移异常后打印异常对象所包含 SQL 过大容易卡死进程的问题 by @cgyrock
  - 调整临时文件的存放位置以支持集群模式 by @mytharcher

### [v2.0.13](https://www.nocobase.com/cn/blog/v2.0.13)
...
### [v2.0.12](https://www.nocobase.com/cn/blog/v2.0.12)
...
### [v2.0.11](https://www.nocobase.com/cn/blog/v2.0.11)
...
- **[undefined]** 修复升级后提示无法找到 plugin-block-reference 的问题。 ([#8757](https://github.com/nocobase/nocobase/pull/8757)) by @gchust
- **[操作：导出记录]** 修复导出 excel 文件中数字类型字段展示位字符串的问题 ([#8774](https://github.com/nocobase/nocobase/pull/8774)) by @cgyrock
...
- **[UI 模板]**
  ...
  - 修复模板区块事件流修改 props 时不生效的问题。 ([#8765](https://github.com/nocobase/nocobase/pull/8765)) by @gchust
- **[数据源：主数据库]**
...
### [v2.1.0-beta.8](https://www.nocobase.com/cn/blog/v2.1.0-beta.7)
...
- **[操作：导出记录]**
  ...
  - 修复导出 excel 文件中数字类型字段展示位字符串的问题 ([#8774](https://github.com/nocobase/nocobase/pull/8774)) by @cgyrock
- **[区块：列表]** 修复列表区块字段无法使用当前记录变量的问题。 ([#8784](https://github.com/nocobase/nocobase/pull/8784)) by @gchust
- **[数据源：主数据库]**
...
### [v2.1.0-alpha.8](https://www.nocobase.com/cn/blog/v2.1.0-alpha.7)
...
- **[database]**
  ...
  - 修复数据表的视图模板缺少`简单分页`选项问题 ([#8778](https://github.com/nocobase/nocobase/pull/8778)) by @cgyrock
  - 设置数字字段精度验证规则无效 ([#8768](https://github.com/nocobase/nocobase/pull/8768)) by @2013xile
  - 修复 v2 版本的字段自定义正则校验失败 ([#8729](https://github.com/nocobase/nocobase/pull/8729)) by @jiannx
