...
新規作成された承認ワークフローはすべて 2.0 のブロックベースのレイアウトを使用します。既存の 1.x 設定は引き続きサポートされます。1.x の承認を 2.0 のレイアウトに切り替えるには、v2 バージョンを選択してインターフェースを再設定してください。切り替え後は 1.x に戻すことはできません。
...
新規作成された CC ノードでは、受信者の閲覧画面はすべて 2.0 のブロックベースのレイアウトを使用します。既存の 1.x 設定は引き続きサポートされます。1.x の CC を 2.0 のレイアウトに切り替えるには、v2 バージョンを選択してインターフェースを再設定してください。切り替え後は 1.x に戻すことはできません。
