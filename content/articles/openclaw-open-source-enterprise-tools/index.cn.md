...
文档：[https://docs.nocobase.com/](https://docs.nocobase.com/?utm_source=chatgpt.com)

AI 文档：[https://docs.nocobase.com/cn/ai/](https://docs.nocobase.com/cn/ai/?utm_source=chatgpt.com)

CLI：[https://docs.nocobase.com/cn/api/cli/](https://docs.nocobase.com/cn/api/cli/?utm_source=chatgpt.com)
...
OpenClaw + NocoBase：[https://docs.nocobase.com/cn/ai/openclaw](https://docs.nocobase.com/cn/ai/openclaw?utm_source=chatgpt.com)
...
文档：[https://docs.n8n.io/](https://docs.n8n.io/?utm_source=chatgpt.com)

AI 文档：[https://docs.n8n.io/advanced-ai/](https://docs.n8n.io/advanced-ai/?utm_source=chatgpt.com)

AI 工作流入门：[https://docs.n8n.io/advanced-ai/intro-tutorial/](https://docs.n8n.io/advanced-ai/intro-tutorial/?utm_source=chatgpt.com)

AI Workflow Builder：[https://docs.n8n.io/advanced-ai/ai-workflow-builder/](https://docs.n8n.io/advanced-ai/ai-workflow-builder/?utm_source=chatgpt.com)

3. ## RAGFlow

![RAGFlow.png](https://static-docs.nocobase.com/RAGFlow-ui3t4v.png)

**官网**： [https://ragflow.io/](https://ragflow.io/?utm_source=chatgpt.com)

**GitHub**： [https://github.com/infiniflow/ragflow](https://github.com/infiniflow/ragflow?utm_source=chatgpt.com)
...
文档：[https://ragflow.io/docs/](https://ragflow.io/docs/?utm_source=chatgpt.com)

API 文档：[https://ragflow.io/docs/dev/http\_api\_reference](https://ragflow.io/docs/dev/http_api_reference)

RAGFlow + OpenClaw：[https://ragflow.io/blog/ragflow-x-openclaw-the-enterprise-aware-claw](https://ragflow.io/blog/ragflow-x-openclaw-the-enterprise-aware-claw?utm_source=chatgpt.com)

RAGFlow Skill：[https://clawskills.sh/skills/angusthefuzz-ragflow](https://clawskills.sh/skills/angusthefuzz-ragflow?utm_source=chatgpt.com)
...
文档：[https://docs.erpnext.com/homepage](https://docs.erpnext.com/homepage?utm_source=chatgpt.com)

Frappe Framework：[https://github.com/frappe/frappe](https://github.com/frappe/frappe?utm_source=chatgpt.com)

Frappe REST API 文档：[https://docs.frappe.io/framework/user/en/api/rest](https://docs.frappe.io/framework/user/en/api/rest)

Frappe JS SDK：[https://github.com/frappe/frappe-js-sdk](https://github.com/frappe/frappe-js-sdk?utm_source=chatgpt.com)

5. ## Plane

**官网**： [https://plane.so/](https://plane.so/?utm_source=chatgpt.com)

**GitHub**： [https://github.com/makeplane/plane](https://github.com/makeplane/plane?utm_source=chatgpt.com)
...
开发者文档：[https://developers.plane.so/](https://developers.plane.so/?utm_source=chatgpt.com)

API 文档：[https://developers.plane.so/api-reference/introduction](https://developers.plane.so/api-reference/introduction?utm_source=chatgpt.com)

# FAQ

6. ## 什么样的工作适合交给 OpenClaw ？
...
OpenClaw 只是一个起点。未来的企业应用中，Agent 不再只是聊天入口里的助手，也不只是临时调用工具的执行器，而会逐渐成为企业内部工具体系中的一层智能协作能力。

人不再需要频繁进入每一个系统里查状态、找异常、追进度。Agent 可以持续感知业务变化，再把需要判断和处理的事项带回到人面前。

如果你觉得这篇文章有帮助，欢迎分享给正在探索 AI Agent 和企业内部工具的朋友。
