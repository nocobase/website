...
## 1. NocoBase：柔軟な AI ローコード / ノーコード開発プラットフォーム
...
NocoBase は、データモデル駆動でプラグイン拡張に対応した、オープンソースの AI 駆動型ノーコードプラットフォームです。固定されたフローを前提とする従来の工单（チケット）システムとは異なり、AI の支援を活用しながら、画面、フォーム項目、プロセス、オートメーションルールなどを要件に応じて自由にカスタマイズできます。
