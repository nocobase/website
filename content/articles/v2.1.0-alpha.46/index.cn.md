...
- **[client-v2]** 新增 `TypedVariableInput` 组件，使邮件插件 v2 的 SMTP 端口和安全模式等字段既可以填写类型化常量，也可以填写 `{{ $env.X }}` 变量。([#9637](https://github.com/nocobase/nocobase/pull/9637)) by @Molunerfinn
...
- **[ai]** 升级 `xlsx` 版本以避免安全问题。([#9675](https://github.com/nocobase/nocobase/pull/9675)) by @mytharcher
- **[client]** 增强部分内置 RunJS 函数的自动补全支持。([#9481](https://github.com/nocobase/nocobase/pull/9481)) by @gchust
- **[cli]** 优化 init 和 self update 指引。([#9633](https://github.com/nocobase/nocobase/pull/9633)) by @chenos
...
- **[client-v2]**
  ...
  - 调整所有关系字段选择器，将关联字段限制为最多两层。([#9454](https://github.com/nocobase/nocobase/pull/9454)) by @jiannx
  ...
  - 修复字段赋值配置保留异常的问题。([#9640](https://github.com/nocobase/nocobase/pull/9640)) by @katherinehhh
- **[client]**
  ...
  - 修复 v2 表单切换字段显示状态后字段变为只读的问题。([#9649](https://github.com/nocobase/nocobase/pull/9649)) by @katherinehhh
- **[flow-engine]**
  ...
  - 修复鼠标移到关联字段分组时，字段搜索内容被清空的问题。([#9646](https://github.com/nocobase/nocobase/pull/9646)) by @zhangzhonghe
