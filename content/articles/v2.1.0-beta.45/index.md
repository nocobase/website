...
- **[Block: Gantt]** Added an option for Gantt blocks to focus on today by default. ([#9692](https://github.com/nocobase/nocobase/pull/9692)) by @jiannx
...
- **[ai]** Upgraded `xlsx` version to avoid security issues. ([#9675](https://github.com/nocobase/nocobase/pull/9675)) by @mytharcher
- **[Multi-keyword filter]** Migrated multi-keyword filter to client v2. ([#9691](https://github.com/nocobase/nocobase/pull/9691)) by @gchust
...
- **[client]**
  - Fixed the issue where hidden linked fields still kept old values. ([#9687](https://github.com/nocobase/nocobase/pull/9687)) by @zhangzhonghe
...
- **[Block: Map]** Fixed an issue where map field values were incorrectly converted when switching between text and map display modes on detail pages. ([#9653](https://github.com/nocobase/nocobase/pull/9653)) by @hongboji
