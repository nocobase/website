---
title: "NocoBase v2.1.0-beta.29 : ajout de l'option de limite de plage de dates pour les champs de date dans les formulaires v2"
description: "Notes de version de v2.1.0-beta.29"
---
...
- **[client]**
  - Correction d'un problème où le code JS ne pouvait plus être modifié après avoir défini un champ JS en lecture seule. ([#9404](https://github.com/nocobase/nocobase/pull/9404)) par @gchust
