---
title: "NocoBase v1.7.0-alpha.3 : Prise en charge des actions de tableau en ligne avec mode icône uniquement"
description: "Notes de version de v1.7.0-alpha.3"
---
...
- **[Workflow : Nœud manuel]**
  - Modification du nom de migration pour garantir une réexécution ([#6487](https://github.com/nocobase/nocobase/pull/6487)) par @mytharcher
...
- **[Workflow : Approbation]**
  - Correction de l'erreur de champ de liaison de fichier dans le formulaire de processus par @mytharcher
