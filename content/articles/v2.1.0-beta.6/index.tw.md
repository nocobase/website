---
title: "NocoBase v2.1.0-beta.6：支援以多關鍵字搜尋內建文件，並在單次工具呼叫中閱讀多份文件"
description: "v2.1.0-beta.6 版本發行說明"
---
...
- **[AI 員工]** 更新 AI 聊天框的使用者提示 ([#8717](https://github.com/nocobase/nocobase/pull/8717)) by @heziqiang
...
- **[資料視覺化]** 修正圖表外掛項目文字的 i18n ([#8716](https://github.com/nocobase/nocobase/pull/8716)) by @heziqiang

- **[工作流：JavaScript]** 修正測試案例在 Windows 上無法通過的問題 ([#8722](https://github.com/nocobase/nocobase/pull/8722)) by @mytharcher

- **[範本列印]** 修正 ACL API 變更但未適配外掛的問題 by @mytharcher

- **[工作流：審批]** 在審批操作中過濾關聯值，以避免任何超出權限的資料操作 by @mytharcher
