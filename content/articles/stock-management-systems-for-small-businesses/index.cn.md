...
### NocoBase：开源、灵活的 AI 驱动低代码 / 无代码平台
...
[NocoBase](https://www.nocobase.com/) 是一款开源、AI 驱动的低代码 / 无代码平台，不仅能快速搭建入库、出库、盘点、调拨等基础功能，还可以在 AI 驱动能力的辅助下，根据自身业务流程进行更深度的定制，满足复杂业务场景的需求。
