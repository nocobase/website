...
### NocoBase：オープンソースで柔軟な AI 駆動型ローコード／ノーコードプラットフォーム
...
[NocoBase](https://www.nocobase.com/) は、入庫・出庫・棚卸・移動といった基本機能を迅速に構築できる、オープンソースの AI 駆動型ローコード／ノーコードプラットフォームです。AI 駆動の機能を活用することで、自社の業務フローに合わせた高度なカスタマイズも可能となり、複雑な業務シーンにも対応できます。
