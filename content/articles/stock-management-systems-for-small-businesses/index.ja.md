...
[NocoBase](https://www.nocobase.com/) は、オープンソースの AI ローコード／ノーコードプラットフォームで、入庫・出庫・棚卸・移動といった基本機能を迅速に構築できます。AI の機能を活用することで、自社の業務フローに応じた高度なカスタマイズが可能となり、複雑な業務シーンにも対応できます。
