...
**NocoBase** は、CRM ソリューションの構築に適した、オープンソースの AI 駆動型ノーコード（ゼロコード）／ローコード開発プラットフォームです。

⭐️ [GitHub](https://github.com/nocobase/nocobase)で21.3k のスターを獲得し、多くの開発者から支持されています。
