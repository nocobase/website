...
- [图表配置](https://docs.nocobase.com/cn/data-visualization/guide/chart-options)
- [前端 RunJS](https://docs.nocobase.com/cn/runjs)
- [筛选表单](https://docs.nocobase.com/cn/interface-builder/blocks/filter-blocks/form)
- [AI 搭建 - 界面搭建](https://docs.nocobase.com/cn/ai-builder/ui-builder)
