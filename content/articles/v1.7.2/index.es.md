---
title: "NocoBase v1.7.2: Optimización del rendimiento al procesar archivos XLSX grandes"
description: "Nota de la versión v1.7.2"
---

### 🚀 Mejoras

- **[Acción: Edición por lotes]** Se utiliza `filterByTk` en lugar de `filter` en el modo seleccionado ([#6994](https://github.com/nocobase/nocobase/pull/6994)) por @mytharcher
