---
title: "NocoBase v1.8.0-beta.12: Suporte para adicionar opções de pool a partir de env"
description: "Nota de lançamento da v1.8.0-beta.12"
---
...
- **[cliente]**
  ...
  - Definir displayName do campo em visualização conectada não tinha efeito ([#7130](https://github.com/nocobase/nocobase/pull/7130)) por @aaaaaajie

  - valor padrão do campo de associação sobrescreve dados existentes em subtabela ([#7120](https://github.com/nocobase/nocobase/pull/7120)) por @katherinehhh
