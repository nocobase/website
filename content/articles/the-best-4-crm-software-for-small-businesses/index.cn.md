...
![image-u15h19.png](https://static-docs.nocobase.com/image-u15h19.png)
**NocoBase** 是一款轻量级且高度可扩展的开源、AI 驱动的无代码（零代码）和低代码开发平台。通过快速部署，企业即可拥有一个私有、可控，并结合 AI 驱动能力的无代码（零代码）开发环境，帮助团队更高效地构建各类业务应用，其中也包括搭建一个完全个性化的 CRM 系统
...
**NocoBase** 如果你的小型企业需要一个**高度定制化**的 CRM 系统，能够快速适配复杂的业务流程，那么 NocoBase 是理想的选择。它提供了强大的数据模型驱动和插件化架构，使企业能够灵活地构建并快速部署业务应用。
