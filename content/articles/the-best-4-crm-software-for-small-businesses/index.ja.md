...
![image-3odcbv.png](https://static-docs.nocobase.com/image-3odcbv.png)

**NocoBase** は、軽量で高い拡張性を備えた、オープンソースの AI 駆動型ノーコード（ゼロコード）／ローコード開発プラットフォームです。迅速に導入することで、企業は AI 駆動の機能を取り入れた、プライベートで管理可能な開発環境を構築でき、完全にカスタマイズされた CRM システムを含む、さまざまな業務アプリケーションを効率的に開発できます。
