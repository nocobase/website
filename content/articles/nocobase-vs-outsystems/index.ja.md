...
* **NocoBase**: オープンソースでプラグイン型アーキテクチャを採用した AI 駆動型ローコードアプリケーション開発プラットフォームです。データモデル駆動（Data Model-Driven）を中心に設計されており、AI 駆動の機能を活用することで、高いカスタマイズ性と柔軟性を備え、技術チームによる個別化された業務システム構築に適しています。
