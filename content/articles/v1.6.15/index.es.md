---
title: "NocoBase v1.6.15: Añadir opción de recorte para campo de texto"
description: "Nota de la versión v1.6.15"
---
...
- **[Gestor de archivos]** Añadir opción de recorte para campos de texto de la colección de almacenamiento ([#6604](https://github.com/nocobase/nocobase/pull/6604)) por @mytharcher

- **[Flujo de trabajo]** Mejorar código ([#6589](https://github.com/nocobase/nocobase/pull/6589)) por @mytharcher

- **[Flujo de trabajo: Aprobación]** Soporte para usar plantilla de bloque en el formulario del proceso de aprobación por @mytharcher
...
- **[cliente]**
  - El campo de asociación (selección) muestra N/A al exponer campos de colección relacionados ([#6582](https://github.com/nocobase/nocobase/pull/6582)) por @katherinehhh
...
- **[Bloque: Mapa]** La validación de gestión del mapa no debe pasar con entrada de espacio ([#6575](https://github.com/nocobase/nocobase/pull/6575)) por @katherinehhh
