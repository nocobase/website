...
**[NocoBase](https://www.nocobase.com/)** は、企業内システムの開発を簡素化することを目的とした、オープンソースでセルフホスト可能な AI ローコード／ノーコード開発プラットフォームです。データモデル駆動とプラグイン型アーキテクチャを採用しており、拡張性と柔軟性を備えた複雑な業務システムを迅速に構築できます。現在、[GitHub](https://github.com/nocobase/nocobase) では 21.3k の Star を獲得しています。
