...
**特長**：**NocoBase** は、中小企業や柔軟なカスタマイズを求めるチームに適した、オープンソースの AI 駆動型ノーコード／ローコードプラットフォームです。直感的なドラッグ＆ドロップ操作で BPM アプリケーションを迅速に構築・管理でき、AI の支援によって設定や運用の効率を高めつつ、プラグイン拡張により高い拡張性を備えています。
