...
- **[client]** 创建数据表时可以更改预设id字段类型 ([#8129](https://github.com/nocobase/nocobase/pull/8129)) by @cgyrock
...
- **[AI 员工]** 修复AI对话记录文本不换行的问题 ([#8096](https://github.com/nocobase/nocobase/pull/8096)) by @heziqiang
