---
title: "NocoBase v1.8.0-beta.4: Optimierung der Leistungsprobleme bei der Verarbeitung großer XLSX-Dateien"
description: "Versionshinweise zu v1.8.0-beta.4"
---

### 🚀 Verbesserungen

- **[Aktion: Stapelbearbeitung]** Verwendung von `filterByTk` anstelle von `filter` im Auswahlmodus ([#6994](https://github.com/nocobase/nocobase/pull/6994)) von @mytharcher
