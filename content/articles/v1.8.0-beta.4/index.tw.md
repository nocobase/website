---
title: "NocoBase v1.8.0-beta.4：優化處理大型 XLSX 檔案時的效能問題"
description: "v1.8.0-beta.4 版本發行說明"
---
...
- **[動作：匯入記錄 Pro]** 最佳化處理大型 XLSX 檔案（高列數/高行數資料集）時的效能問題，防止系統當機或無回應。by @aaaaaajie

### 🐛 錯誤修復

- **[客戶端]**
  - assignedField 元件中遺失欄位標題（[#6987](https://github.com/nocobase/nocobase/pull/6987)）by @katherinehhh
