...
### [v2.1.12](https://www.nocobase.com/cn/blog/v2.1.12)
...
### [v2.1.11](https://www.nocobase.com/cn/blog/v2.1.11)
...
- **[CLI]** 准备 npm source dev 依赖 ([#9882](https://github.com/nocobase/nocobase/pull/9882)) by @chenos
...
### [v2.1.10](https://www.nocobase.com/cn/blog/v2.1.10)
...
- **[前端流引擎]** 使用 Flow Surface API 搭建 AI 员工时，默认将当前区块添加到用户上下文中。 ([#9840](https://github.com/nocobase/nocobase/pull/9840)) by @gchust
...
### [v2.2.0-beta.7](https://www.nocobase.com/cn/blog/v2.2.0-beta.7)
...
- **[公开表单]** 区分 v1 和 v2 的公开表单列表，并修复 v2 Configure 入口打开可配置表单详情页的问题。 ([#9851](https://github.com/nocobase/nocobase/pull/9851)) by @katherinehhh
...
### [v2.2.0-beta.6](https://www.nocobase.com/cn/blog/v2.2.0-beta.6)
...
- **[其他]** 优化 AI 知识库检索和相关文档。 ([#9765](https://github.com/nocobase/nocobase/pull/9765)) by @cgyrock
- **[前端流引擎]**

  - 使用 Flow Surface API 搭建 AI 员工时，默认将当前区块添加到用户上下文中。 ([#9840](https://github.com/nocobase/nocobase/pull/9840)) by @gchust
  - 开放 RunJS 浏览器全局变量。 ([#9841](https://github.com/nocobase/nocobase/pull/9841)) by @gchust
...
### [v2.2.0-alpha.3](https://www.nocobase.com/cn/blog/v2.2.0-alpha.3)
...
- **[flow-engine]** 修复移动端半窗内容过长时无法滚动的问题 ([#9871](https://github.com/nocobase/nocobase/pull/9871)) by @zhangzhonghe
- **[AI 员工]** 修复 AI 数据源卡片列表在不同视口宽度下不能自适应的问题。 ([#9924](https://github.com/nocobase/nocobase/pull/9924)) by @cgyrock
- **[迁移管理]** 修复数据库同步表的迁移规则处理问题 by @2013xile
- **[历史记录]** 修复部分数据表的历史记录可能无法保存变更的问题 by @2013xile
- **[企业微信]** 修复在 Client V2 中启用企业微信插件后切换路由菜单时页面短暂白屏的问题 by @2013xile

### [v2.2.0-alpha.2](https://www.nocobase.com/cn/blog/v2.2.0-alpha.2)
...
- **[其他]**
  ...
  - 优化俄语文档翻译，提升措辞、可读性和术语一致性。 ([#9754](https://github.com/nocobase/nocobase/pull/9754)) by @sembaev-a-a
...
- **[前端流引擎]** 让 RunJS 通过资源 API 更新数据后关闭弹窗时，相关数据区块自动刷新 ([#9873](https://github.com/nocobase/nocobase/pull/9873)) by @gchust
- **[Client V2]**
...
- **[CLI]**
  ...
  - 准备 npm source dev 依赖 ([#9882](https://github.com/nocobase/nocobase/pull/9882)) by @chenos
  - nb 运行环境 Node.js 版本检测 ([#9749](https://github.com/nocobase/nocobase/pull/9749)) by @chenos
- **[Client]**
...
- **[区块：看板]**
  ...
  - 修复日历等弹窗支持 URL ([#9751](https://github.com/nocobase/nocobase/pull/9751)) by @jiannx
