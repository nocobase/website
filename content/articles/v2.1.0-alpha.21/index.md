...
- **[AI employees]** The workflow has added AI employee instruction ([#9025](https://github.com/nocobase/nocobase/pull/9025)) by @cgyrock
...
- **[Workflow: JavaScript]**
  - Fix security issue of script executing in `node:vm` mode ([#9084](https://github.com/nocobase/nocobase/pull/9084)) by @mytharcher
