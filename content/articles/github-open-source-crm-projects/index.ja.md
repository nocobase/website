...
[NocoBase](https://www.nocobase.com/) は、データモデル駆動と柔軟なプラグインシステムを中核とする、拡張性の高いオープンソースの AI ノーコード（ゼロコード）／ローコード CRM ツールです。AI の機能を活用することで、企業に高度にカスタマイズ可能な顧客管理ソリューションを提供します。
