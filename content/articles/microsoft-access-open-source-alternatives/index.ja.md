...
NocoBase は、企業向けアプリケーションや業務システムの構築を目的とした、拡張性の高いオープンソースの AI ローコード／ノーコードプラットフォームです。可視化されたデータモデリング、権限管理、ワークフロー設定に対応しており、プラグインによって柔軟に機能を拡張し、複雑な業務要件にも対応できます。
