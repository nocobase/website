...
NocoBase は、企業向けアプリケーションや業務システムの構築を目的とした、拡張性の高いオープンソースの AI 駆動型ローコード／ノーコードプラットフォームです。可視化されたデータモデリング、権限管理、ワークフロー設定に対応しており、AI 駆動の機能を活用しながら、プラグインによって柔軟に機能を拡張できます。
