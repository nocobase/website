...
NocoBase は、オープンソースでセルフホスト可能な、AI を活用した高い拡張性を備えるノーコード／ローコード開発プラットフォームです。柔軟で扱いやすく、プラグインとモジュール化された仕組みにより、エンタープライズ向けアプリケーションを迅速に構築・拡張できるよう設計されています。
...
💡 続きを読む：[GitHubで最もスター数の多いAirtable代替ツール](https://www.nocobase.com/ja/blog/open-source-airtable-alternatives)
