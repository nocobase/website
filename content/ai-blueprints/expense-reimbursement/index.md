...
These records can also be managed as a NocoBase-based internal business system, with reimbursement requests, expense items, receipts, cost centers, currencies, approval status, and finance reports organized through configurable data models, role permissions, views, workflows where needed, and operation history.

You can copy the prompt below and let an AI agent generate the basic structure of the expense reimbursement system in NocoBase, then adjust data models, fields, pages, expense categories, and approval flows through the no-code UI.
...
For expense reimbursement workflows, the AI Agent can first draft collections, relationships, prompts, and analysis logic around reimbursement requests, expense items, receipts, cost centers, currencies, approval status, and finance reports. NocoBase then keeps the data model, permissions, workflows, pages, and operation history maintainable after launch.
