...
You can copy the prompt below and let your AI Agent generate the data model and foundation of a satisfaction survey system in NocoBase, then adjust metrics, dimensions, charts, and feedback pages through the no-code interface.
...
Afterwards, HR can still adjust questionnaire items, statistics, permissions, and charts through NocoBase's no-code interface, without redeveloping every time the survey changes.
