...
You can copy the prompt below and let your AI Agent generate the basic structure of an asset management system in NocoBase, then adjust fields, pages, and workflows through the no-code interface.
