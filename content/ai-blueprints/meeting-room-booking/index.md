...
You can copy the prompt below and let your AI Agent generate the basic data model and structure of the meeting room booking system in NocoBase, then adjust data models, fields, pages, role permissions, and booking rules through the no-code interface.
...
Yes. NocoBase supports role-based permission configuration and action type.
