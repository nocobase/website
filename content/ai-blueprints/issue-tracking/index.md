...
You can copy the prompt below and let your AI Agent generate the basic data model and structure of the issue tracking system in NocoBase, then fine-tune fields, pages, task hierarchies, and workworkflows through the no-code interface.
...
**AI employee generating an issue analysis report:**

![](https://static-docs.nocobase.com/issue-tracking-2-f2wzs0.png)

**Analyzing issues by priority and status:**
...
Once the basic system is generated, the team can keep adjusting the data structure, pages, statuses, and permissions through NocoBase's no-code interface, without asking AI to rewrite the app from scratch for every change.
